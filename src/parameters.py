...
class ProblemParameters:
    ...
    def _validate_position_counts(self) -> None:
        ...
        if invalid_positions:
            raise ValueError(f"Invalid positions in position_counts: {invalid_positions}")
    ...
    def __repr__(self) -> str:
        ...
        return (f"ProblemParameters(NUM_TEAMS={self.NUM_TEAMS}, "
...
class AlgorithmParameters:
    ...
    """
    # Use __slots__ for memory efficiency
    __slots__ = ['NUM_RUNS', 'POPULATION_SIZE', 'MAX_GENERATIONS', 'MUTATION_RATE', 
                'CROSSOVER_PROB', 'ELITISM_SIZE', 'TOURNAMENT_SIZE', 'BOLTZMANN_TEMP',
                'INITIAL_TEMP', 'MIN_TEMP', 'COOLING_RATE', 'MAX_ITERATIONS']
    # General parameters
    NUM_RUNS: int = 30
    ...
    def __repr__(self) -> str:
        """Return a detailed string representation for debugging."""
        return (f"AlgorithmParameters(NUM_RUNS={self.NUM_RUNS}, "
